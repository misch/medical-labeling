...
\subsection{Reference -- all labels inferred from ground truth}
...
\subsection{Positive labels inferred from ground truth}
...
\subsection{Using only gaze observations}
